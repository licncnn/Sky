...
<head>
	...
	<!-- Favicon -->
	<link href="<?php $this->options->Favicon() ?>" rel="icon" type="image/png">

	<!-- Fonts -->
	<link href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700" rel="stylesheet">

	<!-- FontAwesome -->
	<link href="<?php staticFiles("assets/vendor/font-awesome/css/font-awesome.min.css"); ?>" rel="stylesheet">

	<!-- Main CSS -->
	<link type="text/css" href="<?php staticFiles("assets/css/main.min.css"); ?>" rel="stylesheet">

	<!-- Custom CSS -->
	<link type="text/css" href="<?php staticFiles("style.css"); ?>" rel="stylesheet">
